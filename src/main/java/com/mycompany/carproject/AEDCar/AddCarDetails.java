...
Boolean enValid = validateEngineNumber(jTextField15.getText().trim());
if(enValid.equals(Boolean.FALSE)){
JOptionPane.showMessageDialog(null, "Car Detail with "+jTextField15.getText().trim()+" Engine Number already Exist.");
return;
}
}
...
JOptionPane.showMessageDialog(null, "Owner Telephone Numner : Enter Numbers only");
return;
}
}
...
JOptionPane.showMessageDialog(null, "Enter 4 Numbers only");
return;
}
}
